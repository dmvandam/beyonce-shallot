...
`
    ...
    def _determine_dx(self, 
        ...
        """
        return self._generate_vector(min_x, max_x, num_x)[None, :, None]
    ...
    def _determine_dy(self, 
        ...
        """
        return self._generate_vector(min_y, max_y, num_y)[:, None, None]
    ...
    def _determine_rf(self, 
        ...
        """
        rf = self._generate_vector(1, max_rf, num_rf)
